...
const GoogleLogin = () => {
  ...
  GoogleSignin.configure({
    ...
    webClientId:
      '456802105954-e23muh903je9e5hjhms21odr311uhss6.apps.googleusercontent.com', // client ID of type WEB for your server (needed to verify user ID and offline access)
